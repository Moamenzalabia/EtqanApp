...
extension UIImageView {
    ...
    private func imageSnap(text: String?,
        ...
        // Text
//        if let text = text {
//            let attributes = textAttributes ?? [((NSForegroundColorAttributeName as NSString) as NSAttributedStringKey) as NSAttributedStringKey: UIColor.white,
//                                                NSFontAttributeName as NSString: UIFont.systemFont(ofSize: 15.0)]
//            
//            let textSize = text.size(withAttributes: UIFont.systemFont(ofSize: 15.0))
